...
public class CommentDAO {
	...
	public List<Comment> selectCommentList(Connection conn, int input) throws Exception{
		...
		try {
			...
			while(rs.next()) {
				...
				com.setCommentContent(rs.getString(2));
				com.setMemberNo(rs.getInt(3));
				com.setMemberName(rs.getString(4));
				com.setCreateDate(rs.getString(5));
	 ...
	 * @return result
	 */
	public int insertComment(int boardNo, String commentContent, int memberNo, Connection conn) throws Exception{
